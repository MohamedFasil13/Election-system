...
public class ContributionDao {
    ...
    public boolean saveContribution(Contribution contribution) {
        String sql = "INSERT INTO public.contribution (employer_epf, employer_etf, employee_epf) VALUES (?, ?, ?)";
    ...
    public boolean updateContribution(Contribution contribution) {
        String sql = "UPDATE public.contribution SET employer_epf=?, employer_etf=?, employee_epf=? WHERE id=?";
    ...
    public boolean deleteContribution(int id) {
        String sql = "DELETE FROM public.contribution WHERE id=?";
